...
public class MetaChartPO extends BasePO {
     ...
     * 图表类型
     *
     * @see com.chinapost.devp.generate.constant.ChartType
     */
    ...
    public <T extends MetaChartPO> T castSubType(boolean featureDeserialize) {
        ...
        } else if (ChartType.TREE.getValue().equals(this.chartType)) {
            return (T) TreePO.fromSuperType(this, featureDeserialize);
        }
