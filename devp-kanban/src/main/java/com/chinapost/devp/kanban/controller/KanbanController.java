package com.chinapost.devp.kanban.controller;
...
import com.chinapost.devp.kanban.service.KanbanService;
...
public class KanbanController {
    ...
    public ResponseEntity<?> getKanbanByTitle(@RequestParam String title){
        try {
            ...
            if (optKanban.isPresent()) {
                ...
                return new ResponseEntity<>("No com.chinapost.devp.kanban found with a title: " + title, HttpStatus.NOT_FOUND);
            }
        } catch (Exception e) {
            return errorResponse();
        }
    ...
    private ResponseEntity<String> noKanbanFoundResponse(Long id){
        return new ResponseEntity<>("No com.chinapost.devp.kanban found with id: " + id, HttpStatus.NOT_FOUND);
    }
}
