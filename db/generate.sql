CREATE DATABASE `devp` CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
use `devp`;
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='meta_entity';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='meta_field';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='meta_index';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='meta_index_field';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='meta_const';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='meta_const_detail';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='meta_mtm';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='级联扩展';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='多对多级联扩展';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='gen_history';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='代码模板';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='模板文件';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='图表数据源';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='图表数据源项';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='图表';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='看板';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='项目组';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='项目组成员';
...
(
    ...
    `project_id`       bigint(20)   NOT NULL COMMENT '工程主键id',
    `db_connect_name`  varchar(32)  NOT NULL COMMENT '数据库连接名',
    `dialect_name`     varchar(16)  NOT NULL DEFAULT 'MYSQL' COMMENT '数据库类型',
    `db_host`          varchar(128) NOT NULL COMMENT '数据库主机地址',
    `db_port`          int(11)      NOT NULL COMMENT '数据库主机端口',
    `db_name`          varchar(32)  NOT NULL COMMENT '数据库名',
    `db_user`          varchar(32)  NOT NULL COMMENT '数据库登录账号',
    `db_password`      varchar(32)  NOT NULL COMMENT '数据库登录账号密码',
    `is_save_password` int(1)       NOT NULL DEFAULT '0' COMMENT '是否保存数据登录账号密码',
    `order_no`         int(11)      NOT NULL DEFAULT '1' COMMENT '排序号【整型】',
    `created_time`     datetime     NOT NULL COMMENT '创建时间【yyyy-MM-dd HH:mm:ss】',
    `created_by`       varchar(20)  NOT NULL COMMENT '创建人【最大长度20】',
    `operated_time`    datetime     NOT NULL COMMENT '修改时间【yyyy-MM-dd HH:mm:ss】',
    `operated_by`      varchar(20)  NOT NULL COMMENT '修改人【最大长度20】',
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='数据源配置信息表';

COMMIT;


INSERT INTO `user_setting`(`id`, `username`, `template_enabled`, `created_time`, `created_by`, `operated_time`,
                           `operated_by`, `version`, `deleted`)
VALUES (1, 'admin', 0, '2020-12-31 15:45:42', 'admin', '2020-12-31 15:45:42', 'admin', 1, 0);
COMMIT;
